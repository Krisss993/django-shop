    ...
    def form_valid(self, form):
        ...
        if selected_shipping_address:
            ...
            address = Address.objects.create(
                ...
                address_line_1=form.cleaned_data['Adres_zamieszkania1'],
                address_line_2=form.cleaned_data['Adres_zamieszkania2'],
        ...
        if selected_billing_address:
            ...
            address = Address.objects.create(
                address_type='B',
                user=self.request.user,
                address_line_1=form.cleaned_data['billing_address_line1'],
                address_line_2=form.cleaned_data['billing_address_line2'],
        ...
        messages.info(self.request, 'Adres dodany poprawnie')
...
class DeliveryView(LoginRequiredMixin, generic.FormView):
    ...
    def form_valid(self, form):
        ...
        order.save()
        return super(DeliveryView, self).form_valid(form)
